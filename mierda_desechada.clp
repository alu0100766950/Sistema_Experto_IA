...
(definstances paradas
	...
	(Anchieta of PARADA (parada "Anchieta") (n_parada 1) (parada_siguiente Cruz_Piedra Museo_Ciencia San_Juan Estacion_Guaguas_Antigua Astrofisico_Francisco_Sanchez)(nodo L_204 L_209 L_217 L_271 L_224 L_203 L_260 L_270 L_253))
    (Cruz_Piedra of PARADA (parada "Cruz de Piedra") (n_parada 2) (parada_siguiente Calvo_Sotelo Lora_Tamayo)(nodo L_204 L_209 L_217 L_253))
    (Calvo_Sotelo of PARADA (parada "Calvo Sotelo") (n_parada 3) (parada_siguiente Ayuntamiento)(nodo L_204 L_253))
    (Ayuntamiento of PARADA (parada "Ayuntamiento") (n_parada 4) (parada_siguiente El_Cristo Quintin_Benito)(nodo L_204 L_253))
    ...
    (Pozo_Cabildo of PARADA (parada "Pozo Cabildo") (n_parada 15) (parada_siguiente Enrique_Romeu Paseo_Oramas)(nodo L_204 L_270))
    ...
    (Trinidad of PARADA (parada "Trinidad") (n_parada 23) (parada_siguiente Anchieta)(nodo L_204 L_203))
    ...
    (Estacion_Guaguas_Antigua of PARADA (parada "Estacion de Guaguas Antigua") (n_parada 35) (parada_siguiente San_Benito Anchieta La_Villa_1)(nodo L_224 L_270 L_253))
    (San_Benito of PARADA (parada "San Benito") (n_parada 36) (parada_siguiente Guardia_Civil Juana_la_Blanca Marcos_Redondo Anchieta)(nodo L_224 L_203 L_270 L_253))
    ...
    (Guardia_Civil of PARADA (parada "Guardia Civil") (n_parada 45) (parada_siguiente Valle_de_Guerra Amanecer_1 San_Benito)(nodo L_224 L_203))
    (Valle_de_Guerra of PARADA (parada "Valle de Guerra") (n_parada 46) (parada_siguiente Guardia_Civil))
    (Juana_la_Blanca of PARADA (parada "Juana la Blanca") (n_parada 47) (parada_siguiente 6_Diciembre Estacion_Guaguas_Antigua)(nodo L_224 L_203))
...
(definstances lineas
    (L_204 of LINEA (nombre_linea "Linea 204")(paradas_linea Anchieta Cruz_Piedra Calvo_Sotelo Ayuntamiento El_Cristo El_Bronco Lomo_Largo La_Rua Achaman Chincanayros El_Rayo_1 El_Rayo_2 El_Pino_1 El_Pino_2 Pozo_Cabildo Enrique_Romeu Turina Granados Falla_1 Falla_2 Tabares_Bartlet Concepcion_Salazar_1 El_Cristo)(numero_paradas 24))
    (L_209 of LINEA (nombre_linea "Linea 209")(paradas_linea Anchieta Cruz_Piedra Lora_Tamayo El_Cardonal)(numero_paradas 4))
    (L_253 of LINEA (nombre_linea "Linea 253")(paradas_linea Anchieta Museo_Ciencia Los_Menceyes Gracia El_Dragon La_Verdellada El_Puente Cruz_Piedra Calvo_Sotelo Ayuntamiento Quintin_Benito Silvero_Alonso Los_Bolos Estacion_Guaguas_Antigua San_Benito)(numero_paradas 15))
    (L_217 of LINEA (nombre_linea "Linea 217")(paradas_linea Anchieta Cruz_Piedra Lora_Tamayo Casa_Venezuela El_Cardonal)(numero_paradas 4))
    (L_271 of LINEA (nombre_linea "Linea 271")(paradas_linea Anchieta San_Juan Catedral Juan_de_Vera Republica_Argentina Concepcion_Salazar_2 Mercedes_1 Mercedes_2 Mercedes_3 Mercedes_4)(numero_paradas 10))
	(L_224 of LINEA (nombre_linea "Linea 224")(paradas_linea Anchieta Estacion_Guaguas_Antigua San_Benito Guardia_Civil Valle_de_Guerra Guardia_Civil San_Benito Juana_la_Blanca Estacion_Guaguas_Antigua)(numero_paradas 9))
	(L_203 of LINEA (nombre_linea "Linea 203")(paradas_linea Anchieta Estacion_Guaguas_Antigua La_Villa_1 La_Villa_Colegio La_Villa_2 La_Villa_3 San_Lazaro San_Benito Guardia_Civil Amanecer_1 Amanecer_2 Tornero Las_Gavias_1 Las_Gavias_2 Miguel_Melo Juana_la_Blanca 6_Diciembre El_Juego Trinidad)(numero_paradas 19))
	(L_260 of LINEA (nombre_linea "Linea 260")(paradas_linea Anchieta Astrofisico Baldios Andres_Rosado Llano_del_Moro)(numero_paradas 5))
	(L_270 of LINEA (nombre_linea "Linea 270")(paradas_linea Anchieta Estacion_Guaguas_Antigua San_Benito Marcos_Redondo Paseo_Oramas Pozo_Cabildo Republica_Argentina_1 Mercedes_4)(numero_paradas 8))
    )

(defrule captura_inicio "Muestreo y captura de opciones del usuario para inicio"    
    (declare (salience 10))
    =>
...
(defrule captura_fin "Muestreo y captura de opciones del usuario para fin"
    (declare (salience 9))
    =>
...
(deffunction recorre_lineas "Función que recorre las lineas" (?num)
    (do-for-all-instances ((?lin1 LINEA))
        (bind $?par_lin (send ?lin1 get-paradadas_linea))
        (bind ?i 0)
        (assert linea_actual ?i (send ?par_lin get-nombre_linea))
        )
    )
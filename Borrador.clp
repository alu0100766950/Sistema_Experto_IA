(defclass PARADA "Definición de la clase PARADA"
    (is-a OBJECT)
    (role concrete)
    (slot parada) ;Nombre de la parada
...
(definstances paradas
	...
	(6_Diciembre of PARADA (parada 6_Diciembre) (n_parada 59) (parada_siguiente El_Juego))
	...
	(Llano_del_Moro of PARADA (parada Llano del Moro) (n_parada 64) (parada_siguiente NULL))

(defclass PARADA "Definición de la clase PARADA"
    ...
    (multislot parada_siguiente [type(PARADA)])
    )
...
(defclass LINEA "Definición de paradas por LINEA"
    (multislot paradas [type(PARADA)])
    )

(definstances lineas
    (L_204 of LINEA (paradas Anchieta Cruz_Piedra Calvo_Sotelo Ayuntamiento El_Cristo El_Bronco Lomo_Largo La_Rua Achaman Chincanayros El_Rayo_1 El_Rayo_2 El_Pino_1 El_Pino_2 Pozo_Cabildo Enrique_Romeu Turina Granados Falla_1 Falla_2 Tabares_Bartlet Concepcion_Salazar_1 El_Cristo Anchieta))
    (L_209 of LINEA (paradas Anchieta Cruz_Piedra Lora_Tamayo El_Cardonal Anchieta))
    (L_253 of LINEA (paradas Anchieta Museo_Ciencia Los_Menceyes Gracia El_Dragon La_Verdellada El_Puente Cruz_Piedra Calvo_Sotelo Ayuntamiento Quintin_Benito Silvero_Alonso Los_Bolos Estacion_Guaguas_Antigua San_Benito Anchieta))
    (L_217 of LINEA (paradas Anchieta Cruz_Piedra Lora_Tamayo Casa_Venezuela El_Cardonal Anchieta))
    (L_271 of LINEA (paradas Anchieta San_Juan Catedral Juan_de_Vera Republica_Argentina Concepcion_Salazar_2 Mercedes_1 Mercedes_2 Mercedes_3 Mercedes_4))
	(L_224 of LINEA (paradas Anchieta Estacion_Guaguas_Antigua San_Benito Guardia_Civil Valle_de_Guerra Guardia_Civil San_Benito Juana_la_Blanca Estacion_Guaguas_Antigua Anchieta))
	(L_203 of LINEA (paradas Anchieta Estacion_Guaguas_Antigua La_Villa_1 La_Villa_Colegio La_Villa_2 La_Villa_3 San_Lazaro San_Benito Guardia_Civil Amanecer_1 Amanecer_2 Tornero Las_Gavias_1 Las_Gavias_2 Miguel_Melo Juana_la_Blanca 6_Diciembre El_Juego Trinidad Anchieta))
	(L_260 of LINEA (paradas Anchieta Astrofisico Baldios Andres_Rosado Llano))
	(L_270 of LINEA (paradas Anchieta Estacion_Guaguas_Antigua San_Benito Marcos_Redondo Paseo_Oramas Pozo_Cabildo Republica_Argentina_1 Mercedes_4))
    )